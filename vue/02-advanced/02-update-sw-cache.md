...
开始之前，您可以查看官网文档 [Service worker](https://pwa.baidu.com/doc/offline-and-cache-loading/01-service-worker-introduction) 相关内容，快速掌握相关基础。
...
* 当我发布了新版本代码，sw.js 文件本身怎么保证能拿到最新，而不是从缓存中读取。如果 sw.js 不能及时更新，service worker 内的缓存的文件就不能更新，项目中怎么解决的呢？
    通过给 sw.js 文件请求增加一个不一样的版本参数，保证每次的都与服务器交互，该步骤是在 `build/swRegister-webpack-plugin` 完成的。
